...
Connections = [1 0.5 2 0 0; 2 0.5 3 0 0; 3 0.5 4 0 0; ...
    ...
    8 0.5 9 0 0; 9 0.5 10 0.1 1; 9 0.7 10 0.3 1; 3 0.7 4 0.1 1; ...
    4 1 5 0.7 1];
nFib=10;
%Connections = [1 0.5 2 0 0; 1 0.8 2 0.4 1];% 1 1 2 0.7 1];
%nFib=30;
...
for count=0:stopcount
    ...
    solapp=PrecomputePairwisePC(RHSAll,Xtilde,XInvFcn,MobFcn,...
    ...
    PreconPW = @(RHS) PrecomputePairwisePC(RHS,Xtilde,XInvFcn,MobFcn,...
        BranchIndices,MasterConnections,SlaveConnections,IntegrationMatrix, ...
        RegGridMatrix,ConstrainedPosNodes,BendForceMat,impcoeff*dt,L,nFib);
