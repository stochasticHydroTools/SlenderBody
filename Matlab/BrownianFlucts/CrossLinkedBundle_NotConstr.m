...
IntDX = pinv(DX);
BMNp1 = stackMatrix(barymat(TrkLoc,sNx,bNx));
...
InvXonNp1Mat = [stackMatrix(RNp1ToN*DX); BMNp1];
...
for count=0:stopcount
    ...
    for iFib=1:nFib
        ...
        Xtilde = XonNp1Mat*[reshape(Xstilde',[],1);XsXTrk(end,:)'];
        ...
        XTrk_p1 = XsXTrk(end,:)'+dt*alphaU(end-2:end);
