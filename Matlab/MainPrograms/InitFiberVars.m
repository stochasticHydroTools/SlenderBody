...
RNToDoubleOversamp = barymat(sOversamp,s,b);
RNToOversamp_st = stackMatrix(RNToDoubleOversamp);
WOversmap = diag(wOversamp);
BendingEnergyMatrix = Eb*stackMatrix((RNToDoubleOversamp*D^2)'*WOversmap*RNToDoubleOversamp*D^2);
WtildeInverse = stackMatrix((RNToDoubleOversamp'*WOversmap*RNToDoubleOversamp)^(-1));
