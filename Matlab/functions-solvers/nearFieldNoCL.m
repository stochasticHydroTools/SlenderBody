...
% THIS FUNCTION is the same as nearField.m except this one
% DOES NOT INTERPOLATE WITH / SET TO THE CENTERLINE VELOCITY
function [utarg,qtype] = nearFieldNoCL(targ,xj,yj,zj,f1j,f2j,f3j,Lf,epsilon,mu,ewald)
    ...
    % Run rootfinder 
    [troot, converged] = rootfinderCheb(xhat, yhat, zhat, targ(1),targ(2),targ(3), tinit); % O(n) per point 
