...
legend('$\epsilon=10^{-2}$, $N_2=6$','$\epsilon=10^{-2}$, $N_2=8$','$\epsilon=10^{-3}$, $N_2=4$',...
    ' $\epsilon=10^{-3}$, $N_2=6$','interpreter','latex')
ylabel('$L^2$ error in $U_\textrm{f}(s)$','interpreter','latex')
