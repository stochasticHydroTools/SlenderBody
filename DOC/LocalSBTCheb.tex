...
\global\long\def\im{\iota}
\global\long\def\Xsth{ \frac{\partial \V{X}_s}{\partial \theta} }
\global\long\def\Xsp{ \frac{\partial \V{X}_s}{\partial \phi} }
\global\long\def\tht{ \frac{\partial \theta}{\partial t} }
\global\long\def\pt{ \frac{\partial \phi}{\partial t} }
\global\long\def\ths{ \frac{\partial \theta}{\partial s} }
\global\long\def\ps{ \frac{\partial \phi}{\partial s} }
\global\long\def\follows{\quad\Rightarrow\quad}
