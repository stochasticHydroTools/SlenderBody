/*Raul P. Pelaez 2016-2021. vector types algebra
...
#define VECATTR inline
  ...
  VECATTR  float3 floorf(float3 a){return make_float3(::floorf(a.x), ::floorf(a.y), ::floorf(a.z));}
  ...
  ////////////////DOUBLE PRECISION//////////////////////
#ifdef SINGLE_PRECISION
  VECATTR double3 make_double3(real4 a){return make_double3(a.x, a.y, a.z);}
#else
  ...
  VECATTR float3 sqrt(const float3 &a){ return make_float3(::sqrt(a.x), ::sqrt(a.y), ::sqrt(a.z));}
  VECATTR double3 sqrt(const double3 &a){ return make_double3(::sqrt(a.x), ::sqrt(a.y), ::sqrt(a.z));}
