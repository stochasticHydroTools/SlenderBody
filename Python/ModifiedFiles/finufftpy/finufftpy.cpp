...
int finufft3d1_cpp(py::array_t<double> xj,py::array_t<double> yj,py::array_t<double> zj,py::array_t<CPX> cj,int iflag,double eps,int ms,int mt,int mu,py::array_t<CPX> fk,int debug, int spread_debug, int spread_sort, int fftw, int modeord, int chkbnds,double upsampfac,int nThreads)
{
    NDArray<double> xja(xj);
    NDArray<double> yja(yj);
...
int finufft3d2_cpp(py::array_t<double> xj,py::array_t<double> yj,py::array_t<double> zj,py::array_t<CPX> cj,int iflag,double eps,py::array_t<CPX> fk,int debug, int spread_debug, int spread_sort, int fftw, int modeord, int chkbnds,double upsampfac, int nThreads)
{
    NDArray<double> xja(xj);
    NDArray<double> yja(yj);
    NDArray<double> zja(zj);
...
PYBIND11_MODULE(finufftpy_cpp, m) {
  ...
  m.def("finufft3d1_cpp", &finufft3d1_cpp, "Python wrapper for 3-d type 1 nufft",
	...
	py::arg("fk").noconvert(),
	py::arg("debug"),py::arg("spread_debug"),py::arg("spread_sort"),
	py::arg("fftw"),py::arg("modeord"),py::arg("chkbnds"),py::arg("upsampfac"),py::arg("nThreads"));
