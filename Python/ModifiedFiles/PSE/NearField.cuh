...
namespace uammd{
  namespace BDHI{
	...
	void Mdot(real3 *MF, real NewShearStrain, cudaStream_t st);
	...
	*/
	...
	struct SaruTransform{
      ...
      void NearField::Mdot(real3 *MF, real NewShearStrain, cudaStream_t st){
	...
	shearStrain = NewShearStrain; // reset shear strain
