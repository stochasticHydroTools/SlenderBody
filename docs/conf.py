...
sys.path.insert(0, os.path.abspath('../Python/cppmodules/'))
sys.path.insert(0, os.path.abspath('../Python/Dependencies/'))
...
autodoc_mock_imports = ["FiberCollectionC", "CrossLinkForceEvaluator", "DomainC", "EndedCrossLinkedNetwork", "RPYKernelEvaluator", "StericForceEvaluatorC"]
